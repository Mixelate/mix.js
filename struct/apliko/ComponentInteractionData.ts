...
export const ComponentInteractionData =
  CreateNewDataStore<ComponentInteractionDataModel>("interaction_data");
...
export const CreateComponentInteractionData = async (
  input: ComponentInteractionData
): Promise<string> => {
...
export const FetchComponentInteractionData = async (
  id: string
): Promise<ComponentInteractionDataModel> => {
  ...
  const componentInteractionData = await FindInDataStore(
    ComponentInteractionData,
    { id: id.replace("apliko:", "") }
  );
