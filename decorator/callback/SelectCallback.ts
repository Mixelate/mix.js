...
export const SelectCallback = (customId: string = CALLBACK_WILDCARD) => (
    target: any,
    _: string,
    descriptor: PropertyDescriptor
) => {
    target[SelectCallbacks] = target[SelectCallbacks]
        || new Map<string, (context: SelectMenuInteractionContext) => Promise<any>>()
