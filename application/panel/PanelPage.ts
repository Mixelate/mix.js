...
import { PanelButtonInteractionContext, PanelContext, PanelSelectMenuInteractionContext } from "./PanelContext";
...
export class PanelPage implements CallbackHandler {
    ...
    constructor(bot: AplikoBot, embeds: AplikoEmbed[], components: AplikoComponent[][]) {
        this._bot = bot
        this._embeds = embeds
